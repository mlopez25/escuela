<div class="col-md-4 latest-posts-grid animated wow slideInLeft ajusteMedidas not" data-wow-delay=".5s">
					...
					<div class="latest-posts-grid-right post-ajuste">
						<a href="<?php echo get_permalink($post->ID) ?>"><div style="background-image:url()" class="img-responsive post-img divImg quoteThumb"><div class="quoteText"><?php the_content(); ?></div></div></a>
